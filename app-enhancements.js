(function () {
  ...
  function notificationForChange(key, value) {
    ...
    if (key === "pf_date_ideas") return { kind: "date", title: `${roleName(identity().role)} updated your date shortlist`, body: "A date idea is waiting for your vote.", url: "dates.html" };
    if (key === "pf_date_selected") return { kind: "date", title: "Your next date has been chosen", body: "Open the planner to see your next pick.", url: "dates.html" };
